...
|---|---|---|---|---|---|---|---|
| 初次快速降温 | 贝叶斯自动整定 | 3.666 | 2.5 | 2.5 | 7.726 | 0.8063 | 0.09247 |
| 初次快速降温 | Z-N 反应曲线法 | 7.054 | 4 | 4 | 7.726 | 1.456 | 0.1939 |
| 初次快速降温 | IMC 内模控制（λ经训练集整定） | 3.887 | 2.517 | 2.517 | 7.726 | 0.6842 | 0.08085 |
| 初次快速降温 | FNN 在线自整定 | 3.626 | 2.517 | 2.517 | 7.726 | 0.7586 | 0.08135 |
| 初次快速降温 | RL 在线自整定 | 3.484 | 1.733 | 1.733 | 7.726 | 0.2289 | 0.06308 |
| 设定温度突变 | 贝叶斯自动整定 | 7.113 | 5 | 4 | 2.735 | 1.297 | 0.09703 |
| 设定温度突变 | Z-N 反应曲线法 | 11.2 | 5 | 4 | 2.262 | 1.765 | 0.1813 |
| 设定温度突变 | IMC 内模控制（λ经训练集整定） | 6.846 | 5 | 4 | 2.822 | 1.177 | 0.08714 |
| 设定温度突变 | FNN 在线自整定 | 6.936 | 5 | 4 | 2.774 | 1.214 | 0.09078 |
| 设定温度突变 | RL 在线自整定 | 6.603 | 5 | 4 | 2.712 | 0.8486 | 0.07395 |
| 持续外界热扰动 | 贝叶斯自动整定 | 15.29 | 6 | 2.8 | 1.969 | 1.547 | 0.1498 |
| 持续外界热扰动 | Z-N 反应曲线法 | 18.75 | 6 | 2.8 | 2.033 | 2.209 | 0.1956 |
| 持续外界热扰动 | IMC 内模控制（λ经训练集整定） | 15.63 | 6 | 2.8 | 2.362 | 1.202 | 0.1454 |
| 持续外界热扰动 | FNN 在线自整定 | 15.29 | 6 | 2.8 | 2.165 | 1.335 | 0.1458 |
| 持续外界热扰动 | RL 在线自整定 | 15.21 | 6 | 2.8 | 2.353 | 1.251 | 0.132 |

留出工况汇总：

| 算法 | 平均 ITAE（°C·h²） | 平均调节时间（小时） | 平均最大过冷（°C） | 平均容量指令方差 | 稳定率 |
|---|---|---|---|---|---|
| 贝叶斯自动整定 | 6.089 | 2.919 | 1.767 | 0.06836 | 1 |
| Z-N 反应曲线法 | 9.799 | 4.671 | 2.164 | 0.1509 | 1 |
| IMC 内模控制（λ经训练集整定） | 6.17 | 3.165 | 1.687 | 0.06221 | 1 |
| FNN 在线自整定 | 6.047 | 2.997 | 1.711 | 0.06387 | 1 |
| RL 在线自整定 | 5.85 | 2.891 | 1.666 | 0.05517 | 1 |
