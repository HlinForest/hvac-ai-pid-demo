...
def _system_diagram_svg() -> str:
    return """
<svg id="system-diagram" viewBox="0 0 1180 420" role="img" aria-labelledby="diagram-title diagram-desc">
  ...
  <g id="node-scheduler" class="node"><rect x="450" y="335" width="210" height="65"/><text x="555" y="362">FNN / RL 低频调度</text><text x="555" y="386" class="small">只建议 Kp、Ki · 2 s</text></g>
  <text x="705" y="381" class="feedback">温度传感器反馈：测温 → 算误差 → PI → 限幅 → 温度变化 → 再测温</text>
</svg>"""
...
#system-diagram{{width:100%;height:auto;background:var(--panel);border-radius:10px}}#system-diagram .node rect,#system-diagram .node circle{{fill:#fff;stroke:#91a4b8;stroke-width:2}}#system-diagram text{{font-size:18px;text-anchor:middle;fill:var(--ink)}}#system-diagram .small{{font-size:14px;fill:var(--muted)}}#system-diagram .tiny{{font-size:12px;fill:var(--muted)}}#system-diagram .feedback{{font-size:13px;fill:var(--muted)}}#system-diagram .active rect,#system-diagram .active circle{{stroke:var(--blue);stroke-width:5;fill:#e8f2ff}}
