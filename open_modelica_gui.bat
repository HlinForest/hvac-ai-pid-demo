...
set "PROJECT_DIR=%~dp0"
set "OMEDIT_EXE=D:\modelica\bin\OMEdit.exe"
...
if not exist "%OMEDIT_APPDATA%\.openmodelica\libraries" mkdir "%OMEDIT_APPDATA%\.openmodelica\libraries"
if exist "D:\modelica\share\omlibrary\cache\index.json" (
  copy /Y "D:\modelica\share\omlibrary\cache\index.json" "%OMEDIT_APPDATA%\.openmodelica\libraries\index.json" >nul
)
