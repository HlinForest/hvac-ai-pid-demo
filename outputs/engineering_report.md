...
|---|---|---|---|---|---|
| 12小时混合动态开环验证 | 7211 | 7.146e-06 | 1.301e-05 | 4.377e-06 | 通过 |
...
|---|---|---|---|---|---|---|---|
| 初次快速降温 | 贝叶斯自动整定 | 4.946 | 4 | 4 | 7.726 | 0.8667 | 0.1052 |
| 初次快速降温 | Z-N 反应曲线法 | 7.054 | 4 | 4 | 7.726 | 1.456 | 0.1939 |
| 初次快速降温 | IMC 内模控制（λ经训练集整定） | 4.345 | 2.567 | 2.567 | 7.726 | 0.5121 | 0.07245 |
| 初次快速降温 | FNN 在线自整定 | 3.98 | 2.55 | 2.55 | 7.726 | 0.5656 | 0.07311 |
| 初次快速降温 | RL 在线自整定 | 3.942 | 1.867 | 1.867 | 7.726 | 0 | 0.05198 |
| 设定温度突变 | 贝叶斯自动整定 | 7.716 | 5 | 4 | 2.898 | 1.219 | 0.1041 |
| 设定温度突变 | Z-N 反应曲线法 | 11.2 | 5 | 4 | 2.262 | 1.765 | 0.1813 |
| 设定温度突变 | IMC 内模控制（λ经训练集整定） | 5.098 | 3.333 | 2.333 | 2.792 | 0.9421 | 0.05579 |
| 设定温度突变 | FNN 在线自整定 | 4.901 | 3.317 | 2.317 | 2.79 | 1.022 | 0.05747 |
| 设定温度突变 | RL 在线自整定 | 4.364 | 3.233 | 2.233 | 2.187 | 0.7716 | 0.03957 |
| 持续外界热扰动 | 贝叶斯自动整定 | 17.18 | 6 | 2.8 | 2.368 | 1.301 | 0.1596 |
| 持续外界热扰动 | Z-N 反应曲线法 | 18.75 | 6 | 2.8 | 2.033 | 2.209 | 0.1956 |
| 持续外界热扰动 | IMC 内模控制（λ经训练集整定） | 14.19 | 6 | 2.8 | 2.541 | 0.7423 | 0.1243 |
| 持续外界热扰动 | FNN 在线自整定 | 14.44 | 6 | 2.8 | 2.512 | 0.8398 | 0.1268 |
| 持续外界热扰动 | RL 在线自整定 | 12.04 | 6 | 2.8 | 1.908 | 0.927 | 0.09451 |

留出工况汇总：

| 算法 | 平均 ITAE（°C·h²） | 平均调节时间（小时） | 平均最大过冷（°C） | 平均容量指令方差 | 稳定率 |
|---|---|---|---|---|---|
| 贝叶斯自动整定 | 4.948 | 3.156 | 1.245 | 0.05952 | 1 |
| Z-N 反应曲线法 | 8.864 | 5 | 1.81 | 0.1427 | 1 |
| IMC 内模控制（λ经训练集整定） | 3.693 | 1.642 | 1.119 | 0.03467 | 1 |
| FNN 在线自整定 | 3.58 | 1.619 | 1.161 | 0.03586 | 1 |
| RL 在线自整定 | 3.536 | 1.428 | 1.053 | 0.02788 | 1 |
