...
在线实跑状态（2026-08-23）：ESP32 与 STM32F103 的完整算法均已通过 Wokwi 构建并进入运行态；详细证据边界见 `outputs_review_v3/mcu_wokwi_validation.csv`。目前尚未取得可复核的串口曲线、目标 ROM/RAM 与最坏周期，因此仍需按 `embedded/README.md` 的清单补齐最终验收。
