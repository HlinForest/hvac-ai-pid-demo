...
> 控制器对比数值来自 Python 3R2C + 延迟/一阶执行器。已实际运行 OpenModelica/DASSL、SciPy 连续方程和 FOPDT/3R2C 三层交叉验证；OpenModelica 状态：未运行：artifacts\runs\v4-20260907-8f3fd5f\modelica\PrecisionCabinetCooling_res.csv 不存在（历史证据见 archive/outputs_review_v3/modelica/PrecisionCabinetCooling_res.csv，当前未复现）。
...
| 初次快速降温 | FNN 在线自整定 | 4.128 | 2.617 | 2.617 | 7.741 | 0.8151 | 0.09821 |
...
| 设定温度突变 | FNN 在线自整定 | 7.104 | 5 | 4 | 2.863 | 1.286 | 0.0927 |
...
| 持续外界热扰动 | FNN 在线自整定 | 15.13 | 6 | 2.8 | 2.02 | 1.406 | 0.1469 |
...
| FNN 在线自整定 | 6.39 | 3.166 | 1.728 | 0.06851 | 1 |
...
|B4|FNN独立部署门|已闭环|`deployment_acceptance.csv`|密封测试均值比=0.9984，95%上界=1.0110|
...
|C6|RL独立部署门|已闭环|`deployment_acceptance.csv`|密封测试均值比=0.9651，95%上界=0.9842|
